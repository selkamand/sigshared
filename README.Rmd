...
|               | 3.  **fraction**                                    |
+---------------+-----------------------------------------------------+
| **Signature   | Lists of signature data.frames, where name of list  |
| Collections** | entry is the name of the signature                  |
+---------------+-----------------------------------------------------+
| **Signature   | Signature level annotations. data.frames with 4     |
| Annotations** | required columns:                                   |
|               |                                                     |
|               | 1.  **signature**                                   |
|               | 2.  **aetiology**                                   |
|               | 3.  **class**                                       |
...
|               | 4.  **count**                                       |
+---------------+-----------------------------------------------------+
| **Catalogue   | Lists of catalogue data.frames (1 per sample) where |
| Collections** | name represents a sample identifier.                |
+---------------+-----------------------------------------------------+
