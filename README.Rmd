...
|                                  | 3.  **fraction**                 |
+----------------------------------+----------------------------------+
| **Signature Collections**        | Lists of signature data.frames,  |
|                                  | where name of list entry is the  |
...
|                                  | 4.  **subclass**                 |
|                                  |                                  |
|                                  | class and subclass of aetiology  |
|                                  | do not need to conform to any    |
|                                  | specific ontology. However, we   |
|                                  | include the data-dictionary used |
|                                  | by sigstash collections below    |
...
|                                  | They can also be simulated from  |
|                                  | signature models. data.frames    |
|                                  | with 4 required columns:         |
|                                  |                                  |
|                                  | 1.  **channel**                  |
|                                  |                                  |
|                                  | 2.  **type**                     |
...
|                                  | represents a sample identifier.  |
+----------------------------------+----------------------------------+
...
|                                  |     (percentage)                 |
+----------------------------------+----------------------------------+
| **Model Specification**          | Named numeric vector where names |
|                                  | represent signatures and values  |
|                                  | represent their proportional     |
